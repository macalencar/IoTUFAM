...
void setBeacon() {
  ...
  uint16_t volt = 3700; // 3300mV = 3.3V
  ...
  oAdvertisementData.setCompleteServices(BLEUUID(beconUUID));
    ...
    beacon_data[3] = 'b';  // URL add  1
    beacon_data[4] = 'i';  // URL add  2
    beacon_data[5] = 't';  // URL add  3
    beacon_data[6] = '.';  // URL add  4
    beacon_data[7] = 'l';  // URL add  5
    beacon_data[8] = 'y';  // URL add  6
    beacon_data[9] = '/';  // URL add  7
    beacon_data[10] = '2';  // URL add  8
    beacon_data[11] = 'V';  // URL add  9
    beacon_data[12] = 'e';  // URL add 10
    beacon_data[13] = 'N';  // URL add 11
    beacon_data[14] = 'g';  // URL add 12
    beacon_data[15] = 'e';  // URL add 13
    beacon_data[16] = 'm';  // URL add 13    
